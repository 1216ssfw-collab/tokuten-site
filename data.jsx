...
const BENEFITS = [
  ...
  {
    id: 5,
    pdf: "assets/kobetsu-soudan.pdf",
    coverImg: "assets/cover-furikaeri.png",
    coverFit: "contain",
    coverBg: "#FDF7EE",
    title: "「参考になりました」で終わる原因を“相手の反応”から見抜く…個別相談・体験セッションのふり返りチェックシート",
    report: "個別相談・体験セッション ふり返りシート",
    desc: "営業が苦手な人ほど、自分の商談を正しく判断できません。このシートは、あなたの話し方ではなく「相手の反応」をもとに、申込みにつながらなかった原因を見つけるためのチェックシートです。",
  },
  {
    id: 6,
    sheetId: "1uzxGJV_nG1ILkHaXgAj4HqDiHtdc7mZxKRrhpQXMq7E",
    coverImg: "assets/cover-amasai.png",
    ctaLabel: "シートを開く",
    title: "前の人には売れたのに、この人には刺さらない…相手のタイプ別に“刺さる言葉”を整理できる営業タイプ別アマサイシート",
    report: "営業タイプ別 アマサイシート",
    desc: "同じ商品でも「誰に・どう伝えるか」で売れ方は変わります。お客様をA：アクティブ／M：マネージ／S：サービス／I：イノベートの4タイプに分け、それぞれに刺さる伝え方を整理できる実践シート。「シートを開く」→「コピーを作成」で、自分用に書き込めます。",
  },
];
